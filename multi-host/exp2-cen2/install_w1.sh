...
docker run -d --name mongodb-exp2-cen2-w1 --net bridge -p 27017:27017 mongodb-exp2-cen2 --replSet rs0
...
docker run -d --name imageprocess-exp2-cen2-w1 --net bridge -p 8091:8091 imageprocess-app-exp2-cen2
